...
<table width="100%"  border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#ffffff" style="border-collapse:collapse">
       ...
       <tr>
        ...
        <td align="center" class="hui">
		 ...
		 <td align="center" class="hui" style="width:300px;"  >
				  ...
				  <button type="button" class="btn btn-default"  onclick="suggestInfo.toDetail('${c.suggestId}','${SuggestType.BUG.getCode()}')">详情</button>
				 </#if>
				 
      			<#if subject.isPermitted("accountExpandInfo:detail")>  <#--tgSuggestBugInfo:edit  -->
				  <button type="button" class="btn btn-default"  onclick="suggestInfo.toEdit('${c.suggestId}','${SuggestType.BUG.getCode()}')">修改</button>
				 </#if>
     ...
     <@pageBar   pager=pager url="/tgSuggestBugInfo/bugList.action?jsonParam=${jsonParam!''}" join="&"> </@pageBar> 
